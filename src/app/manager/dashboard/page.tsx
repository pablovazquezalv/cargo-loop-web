...
import ModalInvitation from '@/app/components/modalInvitation';
...
export default function Dashboard() {
    ...
    useEffect(() => {
        const verifyToken = async () => {
            ...
            const response = await fetch('http://localhost:8000/api/manager/verifyToken', {
                method: 'POST',
                headers: {
    ...
    if (companyId === null) {
        return (
            <div className="p-8  min-h-screen flex flex-col items-center justify-center">
                <h1 className="text-2xl font-bold text-gray-800 mb-4">¡Aún no tienes una empresa registrada!</h1>
                <Button className="bg-blue-800 text-white" onClick={() => setShowModal(true)}>
                Invitar a transportista
            </Button>
    ...
    // Resto del dashboard si companyId existe
    return (
